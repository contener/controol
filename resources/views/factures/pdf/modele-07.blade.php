...
<head>
    ...
    <style>
        ...
        .facture-box { background: #f5f3ff; border: 1px solid #ddd6fe; border-radius: 6px; padding: 8px 12px; margin-top: 6px; }
        .facture-box .lbl { font-size: 9px; text-transform: uppercase; color: #7c3aed; font-weight: bold; }
        .facture-box .num { font-weight: bold; color: #5b21b6; font-size: 13px; }
        ...
        table.lignes th { text-align: left; font-size: 10px; text-transform: uppercase; color: #fff; background: #7c3aed; padding: 7px 8px; }
        table.lignes td { padding: 7px 8px; border-bottom: 1px solid #f3f4f6; }
        .text-right { text-align: right; }
        .remise-col { color: #dc2626; }
        .totaux { width: 260px; margin-left: auto; margin-top: 14px; }
        .totaux td { padding: 3px 8px; }
        .totaux .total-final { font-weight: bold; font-size: 14px; background: #7c3aed; color: #fff; border-radius: 4px; }
        ...
        .footer { margin-top: 24px; text-align: center; font-size: 10px; color: #9ca3af; border-top: 1px solid #f3f4f6; padding-top: 10px; }
    </style>
</head>
<body>
    @php
