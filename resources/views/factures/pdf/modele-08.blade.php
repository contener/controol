...
<head>
    ...
    <style>
        ...
        h1 { font-size: 20px; letter-spacing: 4px; text-transform: uppercase; margin: 0 0 6px; font-weight: 400; }
        .logo { max-height: 45px; margin-bottom: 12px; }
        .muted { color: #9ca3af; }
        ...
        .total-block { text-align: center; margin-top: 50px; }
        .total-block .lbl { margin-bottom: 6px; }
        .total-block .amount { font-size: 30px; }
        .total-block .detail { color: #9ca3af; font-size: 10px; margin-top: 10px; }
        .detail span { margin: 0 10px; }
        .footer { margin-top: 70px; width: 100%; font-size: 10px; color: #9ca3af; }
    ...
    <div class="wrap">
        <div class="center">
            ...
            <div class="muted small">
                @if($apercu['boutique']['adresse']) {{ $apercu['boutique']['adresse'] }} @endif
                @if($apercu['boutique']['ville']) &middot; {{ $apercu['boutique']['ville'] }} @endif
                @if($apercu['boutique']['email']) &middot; {{ $apercu['boutique']['email'] }} @endif
            </div>
        </div>
