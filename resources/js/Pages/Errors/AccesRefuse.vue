...
<template>
    ...
    <div class="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-900 px-4">
        <div class="max-w-md w-full bg-white dark:bg-slate-800 shadow-sm rounded-lg p-8 text-center">
            <div class="text-5xl mb-4">🔒</div>
            <h1 class="text-xl font-bold text-slate-900 dark:text-slate-100">Accès refusé</h1>
