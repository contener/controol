    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <DialogModal :show="confirmingUserDeletion" @close="closeModal">
                ...
                <template #content>
                    Êtes-vous sûr(e) de vouloir supprimer votre compte ? Une fois votre compte supprimé, toutes ses ressources et données seront définitivement effacées. Veuillez saisir votre mot de passe pour confirmer la suppression définitive de votre compte.
