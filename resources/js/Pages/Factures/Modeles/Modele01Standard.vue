...
<template>
    <div class="bg-white text-gray-900 text-sm border-t-[6px] border-blue-700 print:border-t-4">
        <div class="p-8 print:p-6">
        <div class="flex justify-between items-start gap-6 pb-7 border-b-2 border-gray-100">
            <div>
                ...
                <div class="mt-2 text-gray-500 text-xs space-y-0.5">
                    ...
                    <div v-if="apercu.boutique.nui" class="font-medium text-gray-500">NUI : {{ apercu.boutique.nui }}</div>
                </div>
            </div>
            <div class="text-right shrink-0">
                ...
                <div class="text-gray-500 mt-2.5 space-y-0.5 text-xs">
        ...
        <div class="mt-8 bg-gray-50 border-l-4 border-blue-700 rounded-r-lg p-5">
        ...
        <div class="mt-8 rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div v-if="apercu.boutique.note_pied_facture" class="mt-8 pt-4 border-t border-dashed border-gray-200">
            <p class="text-[11px] text-gray-400 italic leading-relaxed">{{ apercu.boutique.note_pied_facture }}</p>
        </div>

        <div class="mt-8 pt-6 border-t border-gray-200 flex justify-between items-end text-xs text-gray-400">
