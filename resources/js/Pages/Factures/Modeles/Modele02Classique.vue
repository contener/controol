...
<template>
    <div class="bg-white text-slate-900 text-sm print:p-0">
        <div class="bg-slate-900 text-white px-8 py-8 flex justify-between items-start gap-6 print:px-6 rounded-b-xl print:rounded-none">
            <div>
                ...
                <div v-if="apercu.boutique.adresse || apercu.boutique.ville || apercu.boutique.pays" class="mt-2.5 flex items-start gap-1.5 text-slate-200">
                ...
                <div class="mt-2 text-slate-400 text-xs space-y-0.5">
            ...
            <div class="text-right shrink-0">
                ...
                <div class="text-slate-300 mt-3 space-y-0.5 text-xs">
        ...
        <div class="p-8 print:p-6">
            ...
            <div class="mt-7 rounded-lg border border-slate-200 overflow-hidden">
            ...
            <div class="mt-5 ml-auto w-72">
                ...
                <div class="mt-3 flex justify-between items-center bg-slate-900 text-white rounded-lg px-4 py-3">
            ...
            <div class="mt-7 border border-slate-200 rounded-lg p-4">
                <div class="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1">Coordonnées de paiement</div>
                <div class="text-slate-500 space-y-0.5">
            ...
            <div v-if="apercu.garantie" class="mt-7 pt-4 border-t border-dashed border-slate-200">
            ...
            <div class="mt-6 pt-5 border-t border-slate-200 flex justify-between items-end text-xs text-slate-400">
