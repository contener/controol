...
<template>
    <div class="bg-white text-slate-900 text-sm font-serif p-10 print:p-0">
        <!-- En-tête élégant -->
        <div class="flex justify-between items-start gap-8 pb-7 border-b-2 border-amber-700/40">
            <div>
                ...
                <div v-if="apercu.boutique.adresse || apercu.boutique.ville || apercu.boutique.pays" class="mt-2.5 flex items-start gap-1.5 text-slate-600 text-xs">
                ...
                <div class="text-slate-500 mt-1.5 space-y-0.5 text-xs">
            ...
            <div class="text-right shrink-0">
                ...
                <div class="text-slate-500 mt-2 space-y-0.5 text-xs">
        ...
        <table class="w-full mt-8 border-collapse">
            <thead>
                <tr class="border-b-2 border-amber-700/60 text-[11px] uppercase tracking-wide text-slate-500">
        ...
        <!-- Signatures -->
        <div class="mt-14 flex justify-between gap-10 text-xs text-slate-500">
            <div class="flex-1 text-center">
                <div class="border-b border-slate-300 h-10">&nbsp;</div>
        ...
        <div class="mt-10 pt-4 border-t border-amber-700/30 text-center text-xs text-slate-400 tracking-wide">
