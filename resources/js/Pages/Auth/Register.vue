...
<template>
    ...
    <div class="min-h-screen flex bg-gray-50">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800">
            ...
            <div class="absolute bottom-0 right-0 w-[28rem] h-[28rem] rounded-full bg-purple-400/20 blur-3xl" />
            ...
            <div class="relative z-10 flex flex-col justify-between p-12 xl:p-16 text-white w-full">
                ...
                <div class="max-w-md">
                    <h1 class="text-4xl xl:text-5xl font-bold leading-tight tracking-tight">
                        ...
                        <span class="text-indigo-200">comme un vrai pro</span>
                    </h1>
                    <p class="mt-5 text-indigo-100 text-lg leading-relaxed">
                    ...
                    <ul class="mt-10 space-y-5">
                        <li v-for="avantage in avantages" :key="avantage.titre" class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-indigo-200">{{ avantage.description }}</div>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <p class="text-sm text-indigo-200">
                    Déjà inscrit·e ?
                    <Link :href="route('login')" class="font-medium text-white underline underline-offset-2 hover:text-indigo-100">
                        Connectez-vous
                    </Link>
                </p>
            </div>
        ...
        <div class="flex-1 flex items-center justify-center px-4 py-12 sm:px-8">
            <div class="w-full max-w-md">
                <div class="lg:hidden flex items-center gap-3 mb-8">
                    <span class="flex items-center justify-center size-10 rounded-xl bg-indigo-600">
                        <ApplicationMark class="h-6 w-auto" />
                    </span>
                    <span class="text-lg font-semibold text-gray-900">Controol</span>
                </div>

                <h2 class="text-2xl font-bold text-gray-900">Créez votre compte</h2>
                <p class="mt-2 text-sm text-gray-500">Gratuit, sans carte bancaire. Votre première boutique en moins de deux minutes.</p>
                        ...
                        <div v-if="form.password" class="mt-2">
                            <div class="flex gap-1">
                                <span
                                    ...
                                    :class="i <= forceMotDePasse.score ? forceMotDePasse.classe : 'bg-gray-200'"
                                />
                            </div>
                            <p class="mt-1 text-xs text-gray-500">Robustesse : {{ forceMotDePasse.label }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <input
                                ...
                                class="block w-full rounded-lg border-gray-300 pl-10 pr-10 py-2.5 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            >
                            <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600" @click="showPasswordConfirmation = !showPasswordConfirmation">
                    ...
                    <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                        <label class="flex items-start gap-2">
                            ...
                            <span class="text-sm text-gray-600">
                                J'accepte les
                                <a target="_blank" :href="route('terms.show')" class="underline text-gray-700 hover:text-gray-900">conditions d'utilisation</a>
                                et la
                                <a target="_blank" :href="route('policy.show')" class="underline text-gray-700 hover:text-gray-900">politique de confidentialité</a>.
                            </span>
                        </label>
                ...
                <p class="lg:hidden mt-6 text-center text-sm text-gray-500">
                    Déjà inscrit·e ?
                    <Link :href="route('login')" class="font-medium text-indigo-600 hover:text-indigo-500">Connectez-vous</Link>
                </p>
